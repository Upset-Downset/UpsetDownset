...
SELF_PLAY_SEARCH_ITERS = 200   #number of mcts search iterations in self play
TEMP = 1.0    #self play temperature
TEMP_THRSHLD = 2    #self play temperature threshold

#TRAINING PARAMETERS
WAIT_TO_TRAIN = 3600   #how long to wait for replay buffer to fill during training (seconds)
MAX_REPLAY_BUFFER = 250000    #max length of training replay buffer
...
NUM_EVAL_PLAYS = 200   #number of games per evaluation
